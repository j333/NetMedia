...
(function($, window) {
    ...
    Plugin.prototype.init = function() {
        ...
        $(node).css("position", "relative").width(WW).height(WH), $(node).css("overflow", self.options.overflow), 
        //define height & width
        ...
        ("x" === self.options.direction || "chocolate" === self.options.direction) && //children position = relative
        $(nodeChildren).css({
            position: "relative",
            overflow: "auto"
        }), //bind to resize
